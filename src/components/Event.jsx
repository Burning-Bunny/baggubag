        ...
        <div className="event_container">
          <div className="event01">
            <div className="event_img">
              <img
                src={process.env.PUBLIC_URL + "/img/main_page/event_img01.jpg"}
                alt=""
              />
            </div>
          ...
          <div className="event02">
            <div className="event_img">
              <img
                src={process.env.PUBLIC_URL + "/img/main_page/event_img02.jpg"}
                alt=""
              />
            </div>
            <h3>뉴 썸머 플로럴</h3>
          ...
          <div className="event03">
            <div className="event_img">
              <img
                src={process.env.PUBLIC_URL + "/img/main_page/event_img03.jpg"}
                alt=""
              />
            </div>
            <h3>트래블 파우치</h3>
